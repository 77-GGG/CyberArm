...
\begin{caseframe}{机械臂的当前局限}{CyberArm}{ Open-loop Prototype}
  ...
  \CasePlace{0.85cm}{5.55cm}{%
    ...
    \end{minipage}}
  \CasePlace{8.65cm}{5.55cm}{%
    \begin{minipage}{6.35cm}
      \RedLabel{模型与实物}\par
      \vspace{0.20cm}
      \Lead{理论可达仍需实机验证}\par
      \vspace{0.20cm}
      \Body{碰撞模型不包含线缆摆动、打印件变形与未知障碍，实际动作还受结构与执行误差影响。}
    \end{minipage}}
\end{caseframe}
...
\begin{caseframe}{项目开源情况}{CyberArm}{ GitHub Repository}
  ...
  \CasePlace{8.65cm}{3.25cm}{%
    ...
    \end{minipage}}
  \CasePlace{0.85cm}{7.65cm}{%
    \begin{minipage}{14.2cm}
      \Body{当前发布状态：公开仓库，尚未配置开源许可证。}
    \end{minipage}}
\end{caseframe}
